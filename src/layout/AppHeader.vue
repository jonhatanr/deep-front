    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
                <img src="img/brand/deep_white_logo.png" alt="logo">
            </router-link>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.facebook.com/deep-mx" target="_blank" rel="noopener"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.instagram.com/deep-mxofficial"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://twitter.com/deep-mx" target="_blank" rel="noopener"
